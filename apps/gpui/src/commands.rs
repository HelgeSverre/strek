...
use crate::{
    ...
    BringForward, BringToFront, ChooseTextFontFamily, ClearGuides, Copy, CopyAsPng, CopyAsSvg,
    CopyAsWebP, Cut, DecreaseGridMajorInterval, DecreaseGridSpacing, DecreaseSnapTolerance, Delete,
    ...
    FrameTool, Group, IncreaseGridMajorInterval, IncreaseGridSpacing, IncreaseSnapTolerance,
    InvertSelection, JoinPaths, LineTool, NewDocument, OpenDocument, OpenKeyboardShortcuts, Paste,
    PenTool, QuitApplication, RectangleTool, Redo, ReversePath, SaveCurrentColor, SaveDocument,
...
pub(crate) const COMMANDS: &[CommandSpec] = &[
    ...
    app_command!(
        "text.font_family",
        "Choose Font…",
        "Search installed font families for the selected text",
        "Text",
        [],
        ChooseTextFontFamily
    ),
...
pub(crate) fn action_for(target: CommandTarget) -> Box<dyn Action> {
    match target {
        ...
        CommandTarget::App(action) => match action {
            ...
            AppCommand::ChooseTextFontFamily => Box::new(ChooseTextFontFamily),
